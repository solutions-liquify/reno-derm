...
const tabs: { key: Key; label: string; hint: string }[] = [
  { key: "skin", label: "Skin, Hair & Nail", hint: "Dr. Vyoma" },
  { key: "kidney", label: "Kidney & Metabolic", hint: "Dr. Akash" },
];
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <SectionHeading
            ...
            title="What we treat,"
            accent="and how."
            description="Choose a speciality to see the conditions and procedures we handle at the clinic."
          />
          <Reveal delay={0.1}>
            <div
              role="tablist"
              ...
              {tabs.map((t) => {
                ...
                return (
                  <button
                    ...
                    className={`relative rounded-full px-4 py-2.5 text-sm font-semibold transition-colors sm:px-5 ${
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="mt-12"
          >
            <p className="max-w-2xl text-base text-ink-soft">{group.intro}</p>
            <motion.ul
              initial="hidden"
              animate="show"
